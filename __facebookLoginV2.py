...
def reSearchDataFB(HTMLText, rawText1, rawText2, rawText3):
        match = re.search(rawText1, HTMLText)
        matchBis = re.search(rawText2,HTMLText[match.end():])
        matchBisBis = re.search(rawText3,HTMLText[match.end()+matchBis.end():])
        return HTMLText[match.end()+matchBis.end():match.end()+matchBis.end()+matchBisBis.start()]
...
# print(loginFacebook("MinhHuyDev.Contacts", "mhuyhsusi9qqnqh", "M4WA VL3W 724G KZDP A5E3 YBPV GFLS VNXS"))